                ...
                <div class="card mb-4 box-shadow pr-2 pl-2">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-2 pt-0">
                      <button class="btn btn-outline-secondary b-wh p-0 border-0" type="button">-</button>
                      <input type="text" class="form-control p-1" value="1">
                      <button class="btn btn-outline-secondary b-wh p-0 border-0" type="button">+</button>
                      <a class="btn btn-success float-right ml-1 pl-1 pr-1" href="cart.html" data-lid="${lid}">加入购物车</a>
                    </div>
                  </div>
                </div>
              </div>`;
